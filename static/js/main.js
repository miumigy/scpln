...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const sampleInput = {
            ...
            "nodes": [
                { "name": "店舗1", "node_type": "store", "initial_stock": { "完成品A": 30 }, "lead_time": 3, "service_level": 0.95, "moq": {"完成品A": 10}, "order_multiple": {"完成品A": 5}, "storage_capacity": 200, "allow_storage_over_capacity": true, "storage_over_capacity_variable_cost": 0.2, "storage_cost_fixed": 100, "storage_cost_variable": {"完成品A": 0.5}, "backorder_enabled": true },
                { "name": "店舗2", "node_type": "store", "initial_stock": { "完成品A": 25 }, "lead_time": 3, "service_level": 0.95, "moq": {"完成品A": 10}, "order_multiple": {"完成品A": 5}, "storage_capacity": 200, "allow_storage_over_capacity": true, "storage_over_capacity_variable_cost": 0.2, "storage_cost_fixed": 100, "storage_cost_variable": {"完成品A": 0.5}, "backorder_enabled": true },
                { "name": "中央倉庫", "node_type": "warehouse", "initial_stock": { "完成品A": 100 }, "lead_time": 7, "service_level": 0.90, "moq": {"完成品A": 30}, "order_multiple": {"完成品A": 10}, "storage_capacity": 1000, "allow_storage_over_capacity": false, "storage_cost_fixed": 500, "storage_cost_variable": {"完成品A": 0.2}, "backorder_enabled": true },
                { "name": "組立工場", "node_type": "factory", "producible_products": ["完成品A"], "initial_stock": { "完成品A": 50, "材料X": 500, "材料Y": 800 }, "lead_time": 14, "production_capacity": 50, "allow_production_over_capacity": true, "production_over_capacity_fixed_cost": 2000, "production_over_capacity_variable_cost": 10, "reorder_point": {"材料X": 200, "材料Y": 400}, "order_up_to_level": {"材料X": 500, "材料Y": 800}, "moq": {"材料X": 50, "材料Y": 100}, "order_multiple": {"材料X": 25, "材料Y": 50}, "storage_capacity": 2000, "allow_storage_over_capacity": true, "storage_over_capacity_variable_cost": 0.1, "production_cost_fixed": 10000, "production_cost_variable": 50, "storage_cost_fixed": 1000, "storage_cost_variable": {"完成品A": 0.3, "材料X": 0.1, "材料Y": 0.1}, "backorder_enabled": true },
            ...
            "network": [
                { "from_node": "中央倉庫", "to_node": "店舗1", "transportation_cost_fixed": 200, "transportation_cost_variable": 3, "capacity_per_day": 80, "allow_over_capacity": true, "over_capacity_fixed_cost": 100, "over_capacity_variable_cost": 1, "lead_time": 3, "moq": {"完成品A": 20}, "order_multiple": {"完成品A": 10} },
                { "from_node": "中央倉庫", "to_node": "店舗2", "transportation_cost_fixed": 200, "transportation_cost_variable": 3, "capacity_per_day": 80, "allow_over_capacity": true, "over_capacity_fixed_cost": 100, "over_capacity_variable_cost": 1, "lead_time": 3, "moq": {"完成品A": 20}, "order_multiple": {"完成品A": 10} },
