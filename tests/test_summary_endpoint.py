...
class TestSummaryEndpoint(unittest.TestCase):
    ...
    def test_summary_flow(self):
        ...
        payload = {
            ...
            "network": [
                {"from_node": "W", "to_node": "S", "lead_time": 1}
            ],
            "customer_demand": [
                {"store_name": "S", "product_name": "A", "demand_mean": 1, "demand_std_dev": 0}
            ],
        }
    ...
    def test_validation_unknown_link(self):
        payload = {
            "planning_horizon": 1,
            "products": [],
            "nodes": [{"name": "S", "node_type": "store", "initial_stock": {}, "service_level": 0.0}],
