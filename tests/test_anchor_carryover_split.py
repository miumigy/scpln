...
def test_carryover_both_policy_split(tmp_path: Path):
    ...
    agg = {"rows": [
        {"family": "F", "period": "2025-01", "demand": 100.0, "supply": 110.0, "backlog": 0.0},
        {"family": "F", "period": "2025-02", "demand": 100.0, "supply": 100.0, "backlog": 0.0},
        {"family": "F", "period": "2024-12", "demand": 100.0, "supply": 100.0, "backlog": 0.0},
    ]}
    det = {"rows": [
        {"family": "F", "period": "2025-01", "week": "2025-01-Wk1", "demand": 100.0, "supply": 100.0, "backlog": 0.0},
        {"family": "F", "period": "2025-02", "week": "2025-02-Wk1", "demand": 100.0, "supply": 100.0, "backlog": 0.0},
        {"family": "F", "period": "2024-12", "week": "2024-12-Wk1", "demand": 100.0, "supply": 100.0, "backlog": 0.0},
    ]}
    ...
    subprocess.run([
        ...
        "--max-adjust-ratio", "0", "--carryover", "both", "--carryover-split", "0.7"
